  ...
  <div class="port-container">
      <el-row style="margin-bottom: 20px;" :gutter="20">
          ...
          <el-col :span="6">
              <div class="flex-box">
                  <span>开始时间：</span>
                  <el-date-picker v-model="queryForm.startTime" style="display: 100%;" type="date"
          ...
          <el-col :span="6">
              <div class="flex-box">
                  <span>结束时间：</span>
                  <el-date-picker v-model="queryForm.endTime" style="display: 100%;" type="date"
                      value-format="YYYY-MM-DD" placeholder="选择日期">
                  </el-date-picker>
              </div>
          </el-col>
...
const handleEdit = (row) => {
  for (let i of detailHarborList.value) {
